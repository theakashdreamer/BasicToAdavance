...
package com.skysoftsolution.basictoadavance.newFaceWork.cameraUtils.tracking;
...
import com.skysoftsolution.basictoadavance.newFaceWork.cameraUtils.tflite.SimilarityClassifier.Recognition;
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
     ...
     /* canvas = {Canvas@26281}
      mBitmap = null
      mDrawFilter = null
      mFinalizer = {NativeAllocationRegistry$CleanerRunner@26290}
      backgroundUnchanged = false
      isClickable = false
      isSupportVivoNightMode = false
      mAllowHwBitmapsInSwMode = false
      mDensity = 0
      mDrawBackground = false
      mDrawTextCallback = null
      mDrawingTextViewBackground = false
      mEnableInNightMode = true
      mNativeCanvasWrapper = -5476376609431181312
      mNightMode = -1
      mNightModeController = {NightModeController@26291}
      mScreenDensity = 0
      mVivoBaseCanvas = {VivoBaseCanvasImpl@26292}
      shadow$_klass_ = {Class@14278} "class android.graphics.Canvas"
      shadow$_monitor_ = 0*/
